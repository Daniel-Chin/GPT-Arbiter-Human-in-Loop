...
def initClients():
    ...
    clientAsync = openai.AsyncOpenAI(api_key=api_Key)
    clientAsync.chat.completions.create = decorator()(clientAsync.chat.completions.create)

    return client, clientAsync
